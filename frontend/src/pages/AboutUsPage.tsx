...
export default function AboutUsPage() {
    return (
        <section className="flex min-h-screen py-24 relative w-full flex items-center justify-center">
                    ...
                    <div className="w-full flex-col justify-start lg:items-start items-center gap-10 inline-flex">
                        <div className="w-full flex-col justify-start lg:items-start items-center gap-4 flex">
                            ...
                            <ul className="text-gray-500 text-base font-normal leading-relaxed lg:text-start text-center list-disc pl-5">
                                ...
                                <li><strong>Mereu în contact cu proprietarul</strong> – Comunică oricând cu proprietarul apartementului în care locuiești.</li>
                            </ul>
                            <p className="text-gray-500 text-base font-normal leading-relaxed lg:text-start text-center">
                        ...
                        <button className="sm:w-fit w-full px-3.5 py-2 bg-indigo-600 hover:bg-indigo-800 transition-all duration-700 ease-in-out rounded-lg shadow-md justify-center items-center flex">
                            <Link to="/login" className="sm:w-fit w-full px-3.5 py-2 bg-indigo-600 hover:bg-indigo-800 transition-all duration-700 ease-in-out rounded-lg shadow-md justify-center items-center flex">
                            <span className="px-1.5 text-white text-sm font-medium leading-6">Vezi Ofertele</span>
                            </Link>
                        </button>
                    </div>
